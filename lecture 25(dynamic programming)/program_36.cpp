...
// just refer to longest common subsequence and enter the second string as the reverse of origianl string 
...
public:
    ...
    // // using Tabulation S.C = O(len * len)
    // int longestPalindromeSubseq(string text1) {
    //     string text2 = text1;
    //     reverse(text2.begin() , text2.end());
    ...
    // using Space optimized approach S.C = O(len)
    int longestPalindromeSubseq(string text1) {
        string text2 = text1;
        reverse(text2.begin() , text2.end());
...
int main(){
    ...
    Solution obj;
    int ans = obj.longestPalindromeSubseq(str);
